 ...
 * missing them.
 */
function _donotsendreportemail_civix_fixNavigationMenu(&$nodes) {
  $maxNavID = 1;
  ...
  _donotsendreportemail_civix_fixNavigationMenuItems($nodes, $maxNavID, NULL);
}

function _donotsendreportemail_civix_fixNavigationMenuItems(&$nodes, &$maxNavID, $parentID) {
  ...
  foreach ($origKeys as $origKey) {
    ...
    if (isset($nodes[$origKey]['child']) && is_array($nodes[$origKey]['child'])) {
      _donotsendreportemail_civix_fixNavigationMenuItems($nodes[$origKey]['child'], $maxNavID, $nodes[$origKey]['attributes']['navID']);
    }
  }
}
